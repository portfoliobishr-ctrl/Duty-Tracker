...
exports.INITIAL_ROUNDS = exports.INITIAL_PRAYER_SLOTS = exports.INITIAL_STUDENTS = exports.INITIAL_GROUPS = exports.INITIAL_SYSTEM_SETTINGS = void 0;
exports.getRelativeDateString = getRelativeDateString;
exports.isFriday = isFriday;
exports.isHolidayOrSunday = isHolidayOrSunday;
exports.generateInitialCookingDuties = generateInitialCookingDuties;
exports.generateInitialImamLogs = generateInitialImamLogs;
exports.INITIAL_SYSTEM_SETTINGS = {
    id: 1,
    default_holidays: [0, 6], // 0 = Sunday, 6 = Saturday (College Team cooking & Imam). Friday is dedicated No Food Duty.
};
exports.INITIAL_GROUPS = [
...
function isHolidayOrSunday(dateStr, defaultHolidays) {
    if (defaultHolidays === void 0) { defaultHolidays = [0, 6]; }
    var parts = dateStr.split('-');
    var d = new Date(parseInt(parts[0]), parseInt(parts[1]) - 1, parseInt(parts[2]));
    if (d.getDay() === 5)
        return false; // Friday is no food duty
...
function generateInitialCookingDuties() {
    var duties = [];
    // Group 1: Completed turn (3 days ago - Tuesday)
    var d3 = getRelativeDateString(-3);
    duties.push({
        id: "duty-".concat(d3),
        duty_date: d3,
        group_id: 1,
        ...
        breakfast_completed_at: "".concat(d3, "T08:00:00.000Z"),
        lunch_completed: true,
        lunch_completed_at: "".concat(d3, "T13:00:00.000Z"),
    ...
    var d2 = getRelativeDateString(-2);
    duties.push({
        id: "duty-".concat(d2),
        duty_date: d2,
        group_id: 2,
        ...
        is_no_duty: false,
        breakfast_completed: true,
        breakfast_completed_at: "".concat(d2, "T08:00:00.000Z"),
        lunch_completed: true,
        lunch_completed_at: "".concat(d2, "T13:00:00.000Z"),
        active_student_ids: null,
        is_temporary_swap: false,
        notes: 'Completed turn',
        created_at: new Date().toISOString(),
    ...
    var d0 = getRelativeDateString(0);
    var todayIsFriday = isFriday(d0);
    duties.push({
        id: "duty-".concat(d0),
        duty_date: d0,
...
function generateInitialImamLogs(regularRoundId, collegeRoundId) {
    if (collegeRoundId === void 0) { collegeRoundId = '22222222-0000-0000-0000-000000000002'; }
    var logs = [];
    var d8 = getRelativeDateString(-8);
    var d6 = getRelativeDateString(-6);
    var d5 = getRelativeDateString(-5);
    var d4 = getRelativeDateString(-4);
    var d3 = getRelativeDateString(-3);
    var d2 = getRelativeDateString(-2);
    var d1 = getRelativeDateString(-1);
    ...
    logs.push({
        ...
        created_at: "".concat(d8, "T16:15:00Z"),
    });
    ...
    logs.push({
        ...
        status: 'completed',
        notes: 'Round 1 turn completed',
        created_at: "".concat(d6, "T16:15:00Z"),
    });
    ...
    logs.push({
        ...
        status: 'completed',
        notes: 'Round 1 turn completed',
        created_at: "".concat(d5, "T16:15:00Z"),
    });
    ...
    logs.push({
        ...
        status: 'completed',
        notes: 'Round 1 turn completed',
        created_at: "".concat(d4, "T16:15:00Z"),
    });
    ...
    logs.push({
        ...
        status: 'completed',
        notes: 'Round 1 turn completed',
        created_at: "".concat(d3, "T16:15:00Z"),
    });
    ...
    logs.push({
        ...
        created_at: "".concat(d2, "T16:15:00Z"),
    });
    ...
    logs.push({
        ...
        created_at: "".concat(d1, "T16:15:00Z"),
    });
    // --- HADDAD DUTY LOGS (First round completed for requested students) ---
    var haddadRoundId = '22222222-0000-0000-0000-000000000003';
    var haddadCompletedIds = [
    ...
    haddadCompletedIds.forEach(function (studentId, idx) {
        logs.push({
            id: "log-haddad-seed-".concat(idx),
            ...
            status: 'completed',
            notes: 'Round 1 turn completed',
            created_at: "".concat(getRelativeDateString(-haddadCompletedIds.length + idx - 1), "T19:00:00Z"),
        });
    });
    // --- ISHA AZAAN DUTY LOGS (First round completed for requested students) ---
    var ishaAzaanRoundId = '22222222-0000-0000-0000-000000000004';
    var ishaAzaanCompletedIds = [
    ...
    ishaAzaanCompletedIds.forEach(function (studentId, idx) {
        logs.push({
            id: "log-ishaazaan-seed-".concat(idx),
            ...
            status: 'completed',
            notes: 'Round 1 turn completed',
            created_at: "".concat(getRelativeDateString(-ishaAzaanCompletedIds.length + idx), "T20:00:00Z"),
        });
    });
    return logs;
}
